            ...
            $response = Http::timeout(30)
                ...
                ->post('https://gigachat.devices.sberbank.ru/api/v1/chat/completions',[
                    ...
                    'messages' => [
                        [
                            'role' => 'system',
                            'content' => 'Ты — помощник, который анализирует информацию о товарах и отвечает на вопросы по ней.
                        ...
                        Вот информация о которую тебе необходимо знать:
                        https://ayar-chemistry.ru
                        seller: "Али"
                        locations:
                          - city: "Казань"
                            address: "Родина 41"
